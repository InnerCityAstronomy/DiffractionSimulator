...
{
    /// <summary> Implements <see cref="IValueConverter"/> to provide a converter from
    /// <see cref="Image"/> to <see cref="BitmapSource"/>.<para/>
    /// Source: https://stackoverflow.com/questions/10077498/show-drawing-image-in-wpf 
    /// </summary>
    ...
    public class ImageToBitmapSourceConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (myImage.Height > short.MaxValue || myImage.Width > short.MaxValue)
            {//GetHbitmap will fail if either dimension is larger than max short value.
             //Throwing here to reduce cpu and resource usage when error can be detected early.
                throw new ArgumentException($"Cannot convert System.Drawing.Image with either dimension greater than {short.MaxValue} to BitmapImage.\nProvided image's dimensions: {myImage.Width}x{myImage.Height}", nameof(value));
            }
